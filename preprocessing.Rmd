...
```{r}
all_data <- subset(all_data, select=-c(Street, Utilities, LowQualFinSF))
```
...
write.csv(X_train, file = 'Data/train_processed.csv')
...
print(categorical_feats)
  print(categorical_feats[! categorical_feats %in% remove])
```
